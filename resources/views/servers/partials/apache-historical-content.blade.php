    ...
    <div class="col-12">
        <div class="card shadow-sm border-0 bg-white">
            <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex gap-2">
                    <select id="historyMetric" class="form-select form-select-sm" style="width: auto;">
                        @foreach(\App\Services\Monitoring\Support\MetricNames::apacheSelectable() as $key => $label)
            ...
            <div class="card-body">
                ...
                <div id="apache-request-analysis-container" class="mt-4 pt-3 border-top" style="display: none;">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <h6 class="fw-bold mb-0 text-primary">
                                <i class="bi bi-diagram-3-fill me-2"></i>Request & Endpoint Breakdown
                            </h6>
                            <small class="text-muted">Analyzed Window: <span id="apache-analysis-timestamp" class="fw-semibold text-dark">-</span></small>
                        </div>
                        <button class="btn btn-sm btn-outline-secondary" id="apache-close-analysis-btn">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            <div class="p-2 border rounded bg-light d-flex align-items-center justify-content-between">
                                ...
                                <span class="fw-bold fs-6" id="apache-analysis-total-req">0</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-2 border rounded bg-light d-flex align-items-center justify-content-between">
                                <span class="small text-muted">Active Endpoints</span>
                                <span class="fw-bold fs-6 text-primary" id="apache-analysis-active-ep">0</span>
                            </div>
                        </div>
                    </div>

                    <!-- Loading State -->
                    <div id="apache-analysis-loading" class="text-center py-4 d-none">
                        <div class="spinner-border text-primary spinner-border-sm me-2" role="status"></div>
                        <span class="text-muted small">Analyzing requests & resolving endpoint sources...</span>
                    </div>

                    <!-- Empty State -->
                    <div id="apache-analysis-empty" class="text-center py-4 d-none">
                    ...
                    <div id="apache-analysis-content" class="row g-3 align-items-start">
                        ...
                        <div class="col-lg-7">
                            <div class="border rounded p-3 bg-light position-relative d-flex flex-column align-items-center" style="min-height: 320px;">
                                ...
                                <div class="card text-center shadow-sm border-primary mb-4 node-interactive" id="apache-node-parent" style="width: 180px; cursor: pointer; transition: transform 0.15s ease;">
                                    <div class="card-header bg-primary text-white py-1 small fw-bold">Total Requests</div>
                                    <div class="card-body py-2">
                                        <h4 class="mb-0 fw-bold text-primary" id="apache-parent-req-val">0</h4>
                                        <small class="text-muted" id="apache-parent-req-rate">0 req/min</small>
                                    </div>
                                </div>

                                <!-- Children Endpoint Nodes Container -->
                                <div id="apache-endpoint-nodes-list" class="d-flex justify-content-center flex-wrap gap-2 w-100">
                        ...
                        <div class="col-lg-5">
                            <div class="card border shadow-sm">
                                <div class="card-header bg-white py-2 fw-bold small d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge bg-secondary" id="apache-ep-detail-badge">Select Endpoint</span>
                                </div>
                                <div class="card-body p-3">
                                    <div id="apache-ep-detail-body">
